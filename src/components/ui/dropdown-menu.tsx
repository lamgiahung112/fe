...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    className={cn(
      ...
      "bg-popover text-popover-foreground dark:bg-gray-800 dark:text-white dark:border-gray-700",
...
// Shortcut hiển thị bên phải (như phím tắt)
